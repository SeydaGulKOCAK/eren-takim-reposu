...
static const _LocalState_type_support_symbol_names_t _LocalState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, swarm_msgs, msg, LocalState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, swarm_msgs, msg, LocalState)),
  }
};
...
get_message_type_support_handle<swarm_msgs::msg::LocalState>()
{
  return &::swarm_msgs::msg::rosidl_typesupport_cpp::LocalState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, swarm_msgs, msg, LocalState)() {
  return get_message_type_support_handle<swarm_msgs::msg::LocalState>();
}
