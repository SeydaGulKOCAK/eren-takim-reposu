...
bool swarm_msgs__msg__task_trigger__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("swarm_msgs.msg._task_trigger.TaskTrigger", full_classname_dest, 40) == 0);
  }
  swarm_msgs__msg__TaskTrigger * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TaskTrigger */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("swarm_msgs.msg._task_trigger");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TaskTrigger");
