...
bool swarm_msgs__msg__color_zone__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("swarm_msgs.msg._color_zone.ColorZone", full_classname_dest, 36) == 0);
  }
  swarm_msgs__msg__ColorZone * ros_message = _ros_message;
  {  // position
...
{
  /* NOTE(esteve): Call constructor of ColorZone */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("swarm_msgs.msg._color_zone");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ColorZone");
