...
bool swarm_msgs__msg__join_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("swarm_msgs.msg._join_request.JoinRequest", full_classname_dest, 40) == 0);
  }
  swarm_msgs__msg__JoinRequest * ros_message = _ros_message;
  {  // header
  ...
  {  // battery_pct
    ...
    ros_message->battery_pct = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // ready
...
{
  /* NOTE(esteve): Call constructor of JoinRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("swarm_msgs.msg._join_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JoinRequest");
