...
#ifndef SWARM_MSGS__SRV__DETAIL__SET_QR_MAP__FUNCTIONS_H_
#define SWARM_MSGS__SRV__DETAIL__SET_QR_MAP__FUNCTIONS_H_
...
/// Initialize srv/SetQRMap message.
/**
...
/// Create srv/SetQRMap message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * swarm_msgs__srv__SetQRMap_Request__init().
...
/// Destroy srv/SetQRMap message.
/**
 * It calls
 * swarm_msgs__srv__SetQRMap_Request__fini()
...
/// Check for srv/SetQRMap message equality.
/**
...
/// Initialize array of srv/SetQRMap messages.
/**
...
/// Finalize array of srv/SetQRMap messages.
/**
 * It calls
 * swarm_msgs__srv__SetQRMap_Request__fini()
...
/// Create array of srv/SetQRMap messages.
/**
 * It allocates the memory for the array and calls
 * swarm_msgs__srv__SetQRMap_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetQRMap messages.
/**
 * It calls
 * swarm_msgs__srv__SetQRMap_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetQRMap message array equality.
/**
...
/// Copy an array of srv/SetQRMap messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * swarm_msgs__srv__SetQRMap_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_swarm_msgs
...
/**
 * It calls
 * swarm_msgs__srv__SetQRMap_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_swarm_msgs
...
/**
 * It allocates the memory for the array and calls
 * swarm_msgs__srv__SetQRMap_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_swarm_msgs
...
/**
 * It calls
 * swarm_msgs__srv__SetQRMap_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SWARM_MSGS__SRV__DETAIL__SET_QR_MAP__FUNCTIONS_H_
