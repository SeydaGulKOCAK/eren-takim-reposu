...
bool swarm_msgs__msg__safety_event__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("swarm_msgs.msg._safety_event.SafetyEvent", full_classname_dest, 40) == 0);
  }
  swarm_msgs__msg__SafetyEvent * ros_message = _ros_message;
  {  // header
...
PyObject * swarm_msgs__msg__safety_event__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("swarm_msgs.msg._safety_event");
