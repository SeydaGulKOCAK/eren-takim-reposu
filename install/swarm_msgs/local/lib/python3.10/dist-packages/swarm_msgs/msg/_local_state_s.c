...
bool swarm_msgs__msg__local_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("swarm_msgs.msg._local_state.LocalState", full_classname_dest, 38) == 0);
  }
  swarm_msgs__msg__LocalState * ros_message = _ros_message;
  {  // header
...
PyObject * swarm_msgs__msg__local_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("swarm_msgs.msg._local_state");
